...
<html lang="en">
  ...
  <body>
    ...
    $info = $_POST["search"];
    echo  "You searched your disease name $info";
...
?> 
<br>
 <h3  style=" color: green">This Medicines Might Be Helpful For <?php  echo $info ?> </h3>
    ...
    <div class="card">
      <div class="card-body">
       <img src="<?php echo $rows['picture']; ?>" class="card-img-top" alt="..." height = "300px" width = "100px" >
        <p class="card-text"><?php echo $rows['doses']; ?></p>
